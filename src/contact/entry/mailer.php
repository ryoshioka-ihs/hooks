...
$email->addTo($emailAdd)->
       ...
       setHtml(" $name 様<br /><br />この度はIIMヒューマン・ソリューションの会社説明会へご応募くださり、<br />誠にありがとうございます。<br />採用担当より折り返しご連絡いたしますので、<br />今しばらくお待ちください。<br /><br />会社説明会日程: $briefing <br /> 業務体験: $experience <br /> お名前: $name （ $name2 ）<br /> メールアドレス: $emailAdd <br /><br /> 生年月日: $birthday <br /> 性別: $sex <br /> 電話番号: $phone <br /> 応募きっかけ: $enquete <br /> 応募きっかけ/その他を選択した方: $other1 <br /> 現在の状態: $status <br /> 現在の状態/その他を選択した方: $other2 <br /> 最終学歴: $education <br /> 最終学歴/その他を選択した方: $other3 <br /> 最終卒業学校名: $school <br /><br /> ※このメールは自動送信です。<br /> 何かございましたらsaiyou@iimhs.co.jpまでお問い合わせください。")->
       addCategory('contact');
...
$email->addTo($to)->
       ...
       setHtml("下記内容にて会社説明会へのお申込みを受け付けました。<br />ご担当者は確認後、受付メールを送付してください。<br /><br />会社説明会日程: $briefing <br /> 業務体験: $experience <br /> お名前: $name （ $name2 ）<br /> メールアドレス: $emailAdd <br /><br /> 生年月日: $birthday <br /> 性別: $sex <br /> 電話番号: $phone <br /> 応募きっかけ: $enquete <br /> 応募きっかけ/その他を選択した方: $other1 <br /> 現在の状態: $status <br /> 現在の状態/その他を選択した方: $other2 <br /> 最終学歴: $education <br /> 最終学歴/その他を選択した方: $other3 <br /> 最終卒業学校名: $school <br /> ")->
       addCategory('contact');
